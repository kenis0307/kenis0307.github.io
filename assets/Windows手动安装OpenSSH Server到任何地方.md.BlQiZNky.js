import{_ as n,c as a,o as e,ae as p}from"./chunks/framework.Dh1jimFm.js";const k=JSON.parse('{"title":"Windows 手动安装 OpenSSH Server 到任何地方","description":"","frontmatter":{},"headers":[],"relativePath":"Windows手动安装OpenSSH Server到任何地方.md","filePath":"Windows手动安装OpenSSH Server到任何地方.md"}'),i={name:"Windows手动安装OpenSSH Server到任何地方.md"};function l(t,s,o,h,r,c){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="windows-手动安装-openssh-server-到任何地方" tabindex="-1">Windows 手动安装 OpenSSH Server 到任何地方 <a class="header-anchor" href="#windows-手动安装-openssh-server-到任何地方" aria-label="Permalink to &quot;Windows 手动安装 OpenSSH Server 到任何地方&quot;">​</a></h1><h2 id="github-release-下载-zip-包" tabindex="-1">Github Release 下载 zip 包 <a class="header-anchor" href="#github-release-下载-zip-包" aria-label="Permalink to &quot;Github Release 下载 zip 包&quot;">​</a></h2><p><a href="https://github.com/PowerShell/Win32-OpenSSH/releases/download/v9.8.2.0p2-Preview/OpenSSH-Win64.zip" target="_blank" rel="noreferrer">https://github.com/PowerShell/Win32-OpenSSH/releases/download/v9.8.2.0p2-Preview/OpenSSH-Win64.zip</a></p><p>可以使用 Github Proxy 加速下载：<a href="https://github.akams.cn/" target="_blank" rel="noreferrer">https://github.akams.cn/</a></p><h2 id="随意解压到任意路径" tabindex="-1">随意解压到任意路径 <a class="header-anchor" href="#随意解压到任意路径" aria-label="Permalink to &quot;随意解压到任意路径&quot;">​</a></h2><div class="language-powshell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">powshell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>7z x OpenSSH-Win64.zip</span></span></code></pre></div><h2 id="生成密钥" tabindex="-1">生成密钥 <a class="header-anchor" href="#生成密钥" aria-label="Permalink to &quot;生成密钥&quot;">​</a></h2><p>需要生成三个类型的密钥（rsa、ecdsa、ed25519） 密钥保存的路径需要填写到配置文件里的</p><div class="language-powershell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">powershell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">/</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">sshd.exe</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> -f</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> .</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">/</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">sshd_config</span></span></code></pre></div>`,21)]))}const g=n(i,[["render",l]]);export{k as __pageData,g as default};
